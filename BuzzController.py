...
class BuzzController:
    ...
    def get_button_status(self):
        ...
        if data:
            self.buttonState[0]["red"] = ((data[3] & 0x80) != 0)  # red
            self.buttonState[0]["yellow"] = ((data[4] & 0x01) != 0)  # yellow
            self.buttonState[0]["green"] = ((data[4] & 0x02) != 0)  # green
            self.buttonState[0]["orange"] = ((data[4] & 0x04) != 0)  # orange
            self.buttonState[0]["blue"] = ((data[4] & 0x08) != 0)  # blue

            self.buttonState[1]["red"] = ((data[2] & 0x01) != 0)  # red
            self.buttonState[1]["yellow"] = ((data[2] & 0x02) != 0)  # yellow
            self.buttonState[1]["green"] = ((data[2] & 0x04) != 0)  # green
            self.buttonState[1]["orange"] = ((data[2] & 0x08) != 0)  # orange
            self.buttonState[1]["blue"] = ((data[2] & 0x10) != 0)  # blue
            ...
            self.buttonState[3]["red"] = ((data[2] & 0x20) != 0)  # red
            self.buttonState[3]["yellow"] = ((data[2] & 0x40) != 0)  # yellow
            self.buttonState[3]["green"] = ((data[2] & 0x80) != 0)  # green
            self.buttonState[3]["orange"] = ((data[3] & 0x01) != 0)  # orange
            self.buttonState[3]["blue"] = ((data[3] & 0x02) != 0)  # blue
