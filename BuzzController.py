        ...
        def light_blink(self, controller):
            ...
            def get_button_status(self):
                ...
                if data:
                    ...
                    self.buttonState[2]["yellow"] = ((data[4] & 0x01) != 0)  # yellow
                    self.buttonState[2]["green"] = ((data[4] & 0x02) != 0)  # green
                    self.buttonState[2]["orange"] = ((data[4] & 0x04) != 0)  # orange
                    self.buttonState[2]["blue"] = ((data[4] & 0x08) != 0)  # blue
